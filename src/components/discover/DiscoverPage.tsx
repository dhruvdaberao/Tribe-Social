...
const DiscoverPage: React.FC<DiscoverPageProps> = (props) => {
    const { posts, users, tribes, currentUser, onToggleFollow, onViewProfile, onLikePost, onCommentPost, onDeletePost, onDeleteComment, onViewTribe, onJoinToggle, onEditTribe, onSharePost, onLoadMore, hasMore, isFetchingMore } = props;
    ...
    return (
        <div>
            ...
            {!filteredResults ? (
                <div>
                    <h2 className="text-xl font-bold text-primary mb-4 font-display">Suggestions for You</h2>
                    ...
                    {/* Suggestions don't need infinite scroll, but we can load more posts in the background */}
