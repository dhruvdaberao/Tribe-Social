...
const PostViewModal: React.FC<PostViewModalProps> = (props) => {
  ...
  return (
    <div
      ...
      onClick={onClose}
    >
      <button onClick={onClose} className="absolute top-4 left-4 z-10 p-2 bg-black/50 text-white rounded-full hover:bg-black/70 transition-colors" aria-label="Close post view">
