...
const App: React.FC = () => {
    ...
    const fetchData = useCallback(async () => {
        ...
        try {
            ...
            // Don't error log feed fails as it might be 500 from empty feed on fresh implementation
            ...
            // Don't show critical error to user on simple connection glitches, just let them see stored data or loading
        } finally {
            setIsFetching(false);
        }
