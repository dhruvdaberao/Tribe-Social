...
const ChatPage: React.FC<ChatPageProps> = ({ currentUser, allUsers, chukUser, initialTargetUser, onViewProfile, onToggleBlock }) => {
  ...
  return (
    <div
      className="h-[100dvh] min-h-0 w-full bg-background md:bg-surface md:border md:border-border md:shadow-lg flex overflow-hidden relative pb-[calc(4rem+env(safe-area-inset-bottom))] md:pb-0"
    >
      <div
