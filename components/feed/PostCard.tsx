...
// // //   useEffect(() => { setIsExpanded(false); }, [post.id]);
...
// // //   const handleLikeClick = () => {
// // //     onLike(post.id);
// // //     if (!isLiked) setIsAnimating(true);
// // //   };
...
// // //   return (
// // //     <>
// // //     <div className={`bg-surface border-border rounded-2xl shadow-sm ${onModalClose ? '' : 'border mb-6'}`}>
// // //       <div className="flex items-center p-4">
// // //         {onModalClose && (
// // //             <button onClick={onModalClose} className="p-2 mr-2 -ml-2 text-primary rounded-full hover:bg-background"><BackIcon /></button>
// // //         )}
// // //         <div className="w-12 h-12 rounded-full cursor-pointer" onClick={() => onViewProfile(post.author)}>
// // //              <UserAvatar user={post.author} className="w-full h-full" />
// // //         </div>
// // //         <div className="ml-4">
// // //           <p className="font-bold text-primary cursor-pointer hover:underline" onClick={() => onViewProfile(post.author)}>{post.author.name}</p>
// // //           <p className="text-sm text-secondary">{timeAgo(post.timestamp)}</p>
// // //         </div>
// // //         <div className="ml-auto relative">
// // //           <button onClick={() => setOptionsOpen(!optionsOpen)} onBlur={() => setTimeout(() => setOptionsOpen(false), 150)} className="text-secondary p-2 rounded-full hover:bg-background focus:outline-none"><OptionsIcon /></button>
// // //           {optionsOpen && (
// // //             <div className="absolute right-0 mt-2 w-48 bg-surface rounded-lg shadow-lg border border-border z-10 overflow-hidden">
// // //               <ShareButton
// // //                 shareData={{ title: `Post by ${post.author.name}`, text: post.content, url: window.location.href }}
// // //                 className="w-full text-left px-4 py-3 text-primary hover:bg-background transition-colors flex items-center space-x-2"
// // //                 onShare={() => setOptionsOpen(false)}
// // //               >
// // //                   <ExternalLinkIcon /><span>Share Externally</span>
// // //               </ShareButton>
// // //               {isOwnPost && (
// // //                 <button onMouseDown={handleDeletePostClick} className="w-full text-left px-4 py-3 text-red-500 hover:bg-red-50 transition-colors flex items-center space-x-2">
...
// // //       {post.content && (
// // //         <div className="px-4 pb-4">
// // //             <p ref={contentRef} className={`text-primary whitespace-pre-wrap ${!isExpanded ? (post.imageUrl ? 'line-clamp-2' : 'line-clamp-6') : ''}`}>{post.content}</p>
// // //             {isTruncated && !isExpanded && (
// // //                 <button onClick={() => setIsExpanded(true)} className="text-accent font-semibold text-sm hover:underline mt-1">...Show more</button>
// // //             )}
// // //         </div>
// // //       )}
...
// // //       <div className="flex justify-between items-center px-4 py-3 border-t border-b border-border text-secondary text-sm">
// // //         <div className="flex space-x-2">
// // //             <span>{post.likes.length} Likes</span>
// // //             <span>·</span>
// // //             <span className="cursor-pointer hover:underline" onClick={() => setShowComments(prev => !prev)}>{visibleComments.length} Comments</span>
...
// // //       <div className="flex justify-around items-center p-1 text-secondary font-semibold">
// // //         <button onClick={handleLikeClick} onAnimationEnd={() => setIsAnimating(false)} className={`flex items-center space-x-2 p-2 rounded-lg w-full justify-center transition-colors ${isLiked ? 'text-accent hover:bg-accent/10' : 'hover:bg-background'} ${isAnimating ? 'animate-pop' : ''}`}>
// // //           <LikeIcon filled={isLiked} /><span>{isLiked ? 'Liked' : 'Like'}</span>
// // //         </button>
// // //         <button onClick={() => setShowComments(!showComments)} className="flex items-center space-x-2 p-2 rounded-lg hover:bg-background w-full justify-center transition-colors">
// // //           <CommentIcon /><span>Comment</span>
// // //         </button>
// // //          <button onClick={() => setIsShareModalOpen(true)} className="flex items-center space-x-2 p-2 rounded-lg hover:bg-background w-full justify-center transition-colors">
...
// // //           <form onSubmit={handleCommentSubmit} className="flex items-start space-x-2 mb-4">
// // //             <UserAvatar user={currentUser} className="w-8 h-8 flex-shrink-0 mt-1"/>
// // //             <input type="text" value={commentText} onChange={(e) => setCommentText(e.target.value)} placeholder="Write a comment..." className="flex-1 bg-surface border border-border rounded-full px-4 py-2 focus:outline-none focus:ring-2 focus:ring-accent text-primary text-sm min-w-0" />
// // //             <button type="submit" className="text-accent font-semibold text-sm disabled:text-secondary px-3 py-2 flex-shrink-0" disabled={!commentText.trim()}>Post</button>
// // //           </form>
...
// // //                 </div>
// // //                 {(comment.author.id === currentUser.id || isOwnPost) && (
// // //                     <button onClick={() => onDeleteComment(post.id, comment.id)} className="text-secondary p-1.5 rounded-full hover:bg-red-500/10 hover:text-red-500 opacity-0 group-hover:opacity-100 transition-all self-center">
// // //                         <TrashIcon className="h-4 w-4" />
// // //                     </button>
// // //                 )}
// // //               </div>
// // //             ))}
// // //             {visibleComments.length === 0 && <p className="text-sm text-secondary text-center py-2">No comments yet.</p>}
// // //           </div>
// // //         </div>
// // //       )}
// // //     </div>
// // //     {isShareModalOpen && <ShareModal post={post} currentUser={currentUser} users={allUsers} tribes={allTribes} onClose={() => setIsShareModalOpen(false)} onSharePost={onSharePost} />}
// // //     </>
// // //   );
// // // };
...
// // // const ExternalLinkIcon = ({ className = 'h-5 w-5' }: { className?: string }) => <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" /></svg>;
// // // const BackIcon = () => <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" /></svg>;
...
// //       )}
// //       {post.imageUrl && (
// //         <div className="bg-background overflow-hidden max-h-[500px]">
// //           <img 
// //             src={post.imageUrl} 
// //             alt="Post content" 
...
//       )}
//       {post.imageUrl && (
//         <div className="bg-background overflow-hidden h-[400px] md:h-[500px] w-full">
//           <img 
//             src={post.imageUrl} 
//             alt="Post content" 
//             className="w-full h-full object-cover object-center" 
...
const PostCard: React.FC<PostCardProps> = (props) => {
  ...
  return (
    ...
    <div className={`bg-surface border-border rounded-2xl shadow-md ${onModalClose ? '' : 'border mb-6'}`}>
      ...
      {post.imageUrl && (
        <div className="bg-background w-full flex justify-center items-center overflow-hidden">
          {/* 
             Smart sizing: 
             w-full: always take full width
             h-auto: allow natural height to show full image for small ones
             max-h-[600px]: cap the height for tall images
             object-cover: ensures no blank space, fills the box
             object-center: crops from top/bottom evenly if capped
          */}
          <img 
            src={post.imageUrl} 
            alt="Post content" 
