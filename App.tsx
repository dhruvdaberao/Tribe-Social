...
const DiscoverPage = React.lazy(() => import('./components/discover/DiscoverPage'));
const TribesPage = React.lazy(() => import('./components/tribes/TribesPage'));
const TribeDetailPage = React.lazy(() => import('./components/tribes/TribeDetailPage'));
...
import TribeMembersModal from './components/tribes/TribeMembersModal';
...
const PageContainer: React.FC<{ name: NavItem, activeName: NavItem, children: React.ReactNode }> = React.memo(({ name, activeName, children }) => (
...
const App: React.FC = () => {
    ...
    return (
        <div className="bg-background min-h-screen text-primary overflow-hidden">
            ...
            {/* FIX: Changed `allTribes` to `tribes` to fix reference error. */}
