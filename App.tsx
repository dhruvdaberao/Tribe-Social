...
//     // Load seen stories from local storage (minimal data)
//     useEffect(() => {
//         const seen = localStorage.getItem('seenStoryAuthors');
...
//         if (isFetching || (Date.now() - lastFetchTimestamp.current < 2000)) return;
...
//                         const filteredMessages = prev.messages.filter(m => !m.id.startsWith('temp-') || m.text !== message.text);
//                         return { ...prev, messages: [...filteredMessages, {...message, sender}] };
//                     });
//                 }
//             }
//         };
